namespace ServiceWire.ZeroKnowledge
{
  ...
  internal class DigitsArray
  {
    ...
    internal static          int  DataSizeOf => sizeof(uint);

    internal static int DataSizeBits => sizeof(uint) * 8;
    ...
    internal uint this[int index]
    {
      get
      {
        ...
        return IsNegative ? (uint)AllBits : (uint)0;
      }
    ...
    internal bool IsZero => m_dataUsed == 0 || m_dataUsed == 1 && m_data[0] == 0;
    ...
    static DigitsArray()
    {
      ...
      {
        AllBits  = (uint)~(uint)0;
        HiBitSet = (uint)((uint)1 << (DataSizeBits - 1));
      }
    }
  ...
  /// <summary>Represents a integer of abitrary length.</summary>
  /// <remarks>
  ///   <para>
  ///     A BigInteger object is immutable like System.String. The object can not be modifed,
  ///     and new BigInteger objects are created by using the operations of existing BigInteger
  ///     objects.
  ///   </para>
  ///   <para>
  ///     Internally a BigInteger object is an array of ? that is represents the digits of the
  ///     n-place integer. Negative BigIntegers are stored internally as 1's complements, thus every
  ///     BigInteger object contains 1 or more padding elements to hold the sign.
  ///   </para>
  /// </remarks>
  /// <example>
  ///   <code>
  ...
  public class BigInteger
  {
    ...
    /// <summary>Create a BigInteger with an integer value of 0.</summary>
    public BigInteger()
    {
      m_digits = new DigitsArray(1, 1);
    }

    /// <summary>Creates a BigInteger with the value of the operand.</summary>
    ...
    /// <summary>Creates a BigInteger with the value of the operand. Can never be negative.</summary>
    ...
    /// <summary>Creates a BigInteger initialized from the byte array.</summary>
    ...
    /// <summary>
    ///   Creates a BigInteger initialized from <paramref name="length" /> bytes starting at
    ...
    /// <summary>Creates a BigInteger in base-10 from the parameter.</summary>
    /// <remarks>
    ///   The new BigInteger is negative if the <paramref name="digits" /> has a leading -
    ///   (minus).
    /// </remarks>
    ...
    /// <summary>Creates a BigInteger in base and value from the parameters.</summary>
    /// <remarks>
    ///   The new BigInteger is negative if the <paramref name="digits" /> has a leading -
    ///   (minus).
    /// </remarks>
    ...
    /// <summary>
    ///   Copy constructor, doesn't copy the digits parameter, assumes <code>this</code> owns
    ///   the DigitsArray.
    /// </summary>
    ...
    /// <summary>Returns string in hexidecimal of the internal digit representation.</summary>
    /// <remarks>
    ///   This is not the same as ToString(16). This method does not return the sign, but
    ///   instead dumps the digits array into a string representation in base 16.
    /// </remarks>
    ...
    /// <summary>Returns BigInteger as System.Int16 if possible.</summary>
    ...
    /// <summary>Returns BigInteger as System.UInt16 if possible.</summary>
    /// <param name="value"></param>
    /// <returns></returns>
    ...
    /// <summary>Returns BigInteger as System.Int32 if possible.</summary>
    /// <param name="value"></param>
    /// <returns></returns>
    ...
    /// <summary>Returns BigInteger as System.UInt32 if possible.</summary>
    /// <param name="value"></param>
    /// <returns></returns>
    ...
    /// <summary>Returns BigInteger as System.Int64 if possible.</summary>
    /// <param name="value"></param>
    /// <returns></returns>
    ...
    /// <summary>Returns BigInteger as System.UInt64 if possible.</summary>
    /// <param name="value"></param>
    /// <returns></returns>
    ...
    /// <summary>A bool value that is true when the BigInteger is negative (less than zero).</summary>
    /// <value>A bool value that is true when the BigInteger is negative (less than zero).</value>
    public bool IsNegative => m_digits.IsNegative;

    /// <summary>A bool value that is true when the BigInteger is exactly zero.</summary>
    /// <value>A bool value that is true when the BigInteger is exactly zero.</value>
    ...
    /// <summary>Creates a BigInteger from a long.</summary>
    ...
    /// <summary>Creates a BigInteger from a ulong.</summary>
    ...
    /// <summary>Creates a BigInteger from a int.</summary>
    ...
    /// <summary>Creates a BigInteger from a uint.</summary>
    ...
    /// <summary>Adds two BigIntegers and returns a new BigInteger that represents the sum.</summary>
    /// <param name="leftSide">A BigInteger</param>
    /// <param name="rightSide">A BigInteger</param>
    /// <returns>
    ///   The BigInteger result of adding <paramref name="leftSide" /> and
    ///   <paramref name="rightSide" />.
    /// </returns>
    public static BigInteger operator +(BigInteger leftSide, BigInteger rightSide)
    {
      ...
      {
        var sum = (long)leftSide.m_digits[i] + (long)rightSide.m_digits[i] + carry;
    ...
    /// <summary>Increments the BigInteger operand by 1.</summary>
    ...
    /// <summary>Substracts two BigIntegers and returns a new BigInteger that represents the sum.</summary>
    /// <param name="leftSide">A BigInteger</param>
    /// <param name="rightSide">A BigInteger</param>
    /// <returns>
    ///   The BigInteger result of substracting <paramref name="leftSide" /> and
    ///   <paramref name="rightSide" />.
    /// </returns>
    public static BigInteger operator -(BigInteger leftSide, BigInteger rightSide)
    {
      ...
      for (var i = 0; i < da.Count; i++)
      {
        var diff = (long)leftSide.m_digits[i] - (long)rightSide.m_digits[i] - carry;
    ...
    /// <summary>Decrements the BigInteger operand by 1.</summary>
    /// <param name="leftSide">The BigInteger operand.</param>
    ...
    /// <summary>
    ///   Negates the BigInteger, that is, if the BigInteger is negative return a positive
    ///   BigInteger, and if the BigInteger is negative return the postive.
    /// </summary>
    ...
    /// <summary>Creates a BigInteger absolute value of the operand.</summary>
    /// <param name="leftSide">A BigInteger.</param>
    ...
    /// <summary>Multiply two BigIntegers returning the result.</summary>
    /// <remarks>See Knuth.</remarks>
    /// <param name="leftSide">A BigInteger.</param>
    /// <param name="rightSide">A BigInteger</param>
    /// <returns></returns>
    public static BigInteger operator *(BigInteger leftSide, BigInteger rightSide)
    {
      ...
      for (var i = 0; i < leftSide.m_digits.DataUsed; i++)
      {
        ...
        {
          var val = (ulong)leftSide.m_digits[i] * (ulong)rightSide.m_digits[j] + (ulong)da[k] + carry;
    ...
    /// <summary>Divide a BigInteger by another BigInteger and returning the result.</summary>
    ...
    private static void MultiDivide(BigInteger leftSide, BigInteger rightSide, out BigInteger quotient, out BigInteger remainder)
    {
      ...
      ulong secondDivisor = rightSide.m_digits.DataUsed < 2 ? (uint)0 : rightSide.m_digits[rightSide.m_digits.DataUsed - 2];
      ...
      {
        var dividend = ((ulong)remainderDat[pos] << DigitsArray.DataSizeBits) + (ulong)remainderDat[pos - 1];
    ...
    private static void SingleDivide(BigInteger leftSide, BigInteger rightSide, out BigInteger quotient, out BigInteger remainder)
    {
      ...
      var divisor  = (ulong)rightSide.m_digits[0];
    ...
    /// <summary>Perform the modulus of a BigInteger with another BigInteger and return the result.</summary>
    /// <param name="leftSide">A BigInteger divisor.</param>
    /// <param name="rightSide">A BigInteger dividend.</param>
    /// <returns>The BigInteger result.</returns>
    public static BigInteger operator %(BigInteger leftSide, BigInteger rightSide)
    ...
    public static BigInteger operator &(BigInteger leftSide, BigInteger rightSide)
    {
      ...
      for (var idx = 0; idx < len; idx++)
        da[idx] = (uint)(leftSide.m_digits[idx] & rightSide.m_digits[idx]);
      return new BigInteger(da);
    }
    ...
    public static BigInteger operator ~(BigInteger leftSide)
    {
      ...
      for (var idx = 0; idx < da.Count; idx++)
        da[idx] = (uint)~leftSide.m_digits[idx];
    ...
    /// <summary>
    ///   Compare this instance to a specified object and returns indication of their relative
    ///   value.
    /// </summary>
    /// <param name="value">
    ///   An object to compare, or a null reference (<b>Nothing</b> in Visual
    ///   Basic).
    /// </param>
    /// <returns>
    ...
    ///   <list type="table">
    ///     <listheader>
    ///       <term>Return Value</term> <description>Description</description>
    ///     </listheader>
    ///     <item>
    ...
    ///     </item>
    ///     <item>
    ///       <term>Zero</term> <description>This instance is equal to <i>value</i>.</description>
    ///     </item>
    ///     <item>
    ...
    /// <summary>Compare two objects and return an indication of their relative value.</summary>
    /// <param name="leftSide">
    ///   An object to compare, or a null reference (<b>Nothing</b> in Visual
    ///   Basic).
    /// </param>
    ...
    /// <summary>
    ///   Converts the numeric value of this instance to its equivalent base 10 string
    ///   representation.
    /// </summary>
